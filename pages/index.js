  ...
  return (
    <Layout Home>
      ...
      <div id="roadmap" className="overflow-x items-center -mb-[54rem]">
        <div className="my-32 bg-agib-purple h-[45rem] transform -rotate-6 scale-[1.3] opacity-40"></div>
      </div>
      ...
      <div className="relative top-24 overflow-hidden items-center">
        <div className="my-32 bg-agib-sky opacity-100">
          <div
            className="container mx-auto flex flex-col justify-center items-center space-y-8 
